            ...
            <div className="space-y-2">
              {list.map((m) => (
                <Link
                  ...
                  className="flex items-center gap-2 rounded-xl border border-line bg-surface px-3 py-2.5 active:bg-surface-2"
                >
                  <span
                  ...
                  <span className="nums ml-auto font-semibold">{m.total}</span>
                </Link>
              ))}
            </div>
          </div>
