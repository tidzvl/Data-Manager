...
const GROUPS: { title: string; keys: [string[], string][] }[] = [
  {
    title: "Di chuyển",
    keys: [
      [["↑", "↓", "←", "→"], "Đi giữa các ô, qua mọi dòng — kể cả ô chỉ đọc"],
      [["Tab"], "Ô nhập được kế, hết dòng thì tràn sang dòng dưới"],
      [["Shift", "Tab"], "Ô nhập được trước"],
      [["Home"], "Dòng đầu bảng"],
      [["End"], "Dòng cuối bảng"],
    ],
  },
  {
    title: "Gập / mở cây",
    keys: [
      [["Ctrl", "→"], "Mở dòng; đã mở thì đi vào dòng con đầu tiên"],
      [["Ctrl", "←"], "Gập dòng; đã gập thì leo lên dòng cấp trên"],
      [["Enter"], "Ở cột tên: mở / gập dòng"],
      [["Shift", "←"], "Gập tất cả"],
      [["Shift", "→"], "Mở tất cả"],
    ],
  },
  {
    title: "Nhập số",
    keys: [
      [["Enter"], "Ở ô số: mở sửa. Đang sửa: lưu rồi xuống ô dưới"],
      ...
      [["a"], "Thêm đợt trống vào nhóm đang trỏ"],
    ],
  },
  {
    title: "Nhập chữ",
  ...
  },
  {
    title: "Chọn dòng",
    keys: [
      [["Space"], "Tick / bỏ tick dòng đang trỏ (mục hoặc đợt)"],
      [["x"], "Như Space"],
      [["Shift", "↑"], "Nới dải chọn lên"],
      [["Shift", "↓"], "Nới dải chọn xuống"],
      [["Ctrl", "A"], "Chọn tất cả dòng đang hiện"],
      [["Delete"], "Xoá dòng đã chọn (có xác nhận)"],
    ],
  },
  {
    title: "Lệnh nhanh",
